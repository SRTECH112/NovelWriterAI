...
✅ Word count is at least 600 words (MANDATORY MINIMUM)
...
- Each beat should take 200-400 words to fully realize
...
TOTAL CHAPTER LENGTH: 600 words minimum (aim for 1,500-2,000 words)
` : '';
...
Write the chapter now as valid JSON.`;
  ...
  const response = await openai.chat.completions.create({
    ...
    temperature: 0.8,
    max_completion_tokens: 12000, // Increased to encourage longer chapters (2000+ words)
  });
